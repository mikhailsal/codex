...
| **7** | **CLI `list` / `show` / `tools` / `tool`** | `tool-transcript/07-cli-list-show` | [#7](https://github.com/mikhailsal/codex/pull/7) | смержен 2026-08-05 |
...
- [x] PR открыт и смержен: [mikhailsal/codex#7](https://github.com/mikhailsal/codex/pull/7).
...
7. [x] CLI list/show — stage 7 / [PR #7](https://github.com/mikhailsal/codex/pull/7) смержен (заменяет stub [PR #5](https://github.com/mikhailsal/codex/pull/5));
